...
latex_documents = [
    (master_doc, 'MSPPy.tex', 'MSPPy Documentation',
     'Lingquan Ding', 'manual'),
]
...
man_pages = [
    (master_doc, 'msppy', 'MSPPy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MSPPy', 'MSPPy Documentation',
     author, 'MSPPy', 'One line description of project.',
     'Miscellaneous'),
]
